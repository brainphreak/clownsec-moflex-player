...
/* Portable shim: this Helix fork was patched for Arduino/ESP. On a normal toolchain the
 * flash-string helpers are no-ops (tables live in regular memory, read directly). */
#ifndef PROGMEM
#define PROGMEM
#endif
