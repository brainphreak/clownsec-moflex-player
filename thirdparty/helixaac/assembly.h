...
#elif defined(ARDUINO) || (defined(__GNUC__) && defined(__arm__)) || defined(__GNUC__) && (defined(__mips__) || defined(__MIPS__)) || defined(__GNUC__) && (defined(__powerpc__) || defined(__POWERPC__)) || (defined (_SOLARIS) && !defined (__GNUC__) && !defined (_SOLARISX86))
/* devkitARM (3DS ARM11) routed here: portable-C intrinsics, no inline asm. */
