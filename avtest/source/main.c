...
extern int    mobi_opt;
extern int    mobi_err[16];
extern int    mobi_sub[3];   /* substitution tier taken: 0=forward-walk 1=any-frame 2=POOL EMPTY(black->green) */
...
int main(void) {
    ...
    y2r_setup();
    mobi_opt = 0xDA0E;          /* + missing-ref tolerance: post-skip recovery in ~5 frames, not seconds */
