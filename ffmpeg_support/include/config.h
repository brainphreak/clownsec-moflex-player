...
#define FFMPEG_CONFIGURATION "--disable-everything --disable-programs --disable-doc --disable-network --disable-autodetect --enable-demuxer=moflex --enable-decoder='mobiclip,adpcm_ima_moflex,fastaudio' --enable-protocol=file"
